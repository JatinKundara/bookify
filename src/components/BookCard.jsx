...
function BookCard(props) {
    ...
    return (
        <li className='overflow-hidden w-[14rem]'>
            <a onClick={(e) => navigate(`/book-details/${props.id}`)} className="group overflow-hidden cursor-pointer">
                ...
                <div className="relative bg-white pt-1">
                    <h3 className="text-xl font-semibold text-black group-hover:underline group-hover:underline-offset-4 overflow-hidden whitespace-nowrap text-ellipsis max-w-full">
                        {/* The Kite Runner */}
                        {props?.bname}
                    </h3>
